protoc-jar
==========
This project is fork from [protoc-jar](https://github.com/os72/protoc-jar) and further support will take place in this
repository

Protocol Buffers protobuf compiler - multi-platform executable protoc JAR and API. Available on Maven
Central: https://repo1.maven.org/maven2/io/github/minhhoangvn/protoc-jar/

[![Maven Central](https://img.shields.io/badge/maven%20central-3.21.4-brightgreen.svg)](http://search.maven.org/#artifactdetails|io.github.minhhoangvn|protoc-jar|3.21.4|)

---

Simple convenience JAR that embeds protoc compiler binaries for Linux, Mac/OSX, and Windows, providing some portability
across the major platforms. At runtime the library detects the platform and executes the corresponding protoc binary.
Supports embedded protoc versions 2.4.1, 2.5.0, 2.6.1, 3.11.4, and any protoc version available for download from maven
central
...
* Support for Linux on POWER8 platform (linux-ppcle_64), now from Google
    * Older versions (up to 3.6.0), thanks to [Apache SystemML](https://github.com/apache/systemml)
      folks ([nakul02](https://github.com/nakul02))
